...
<head>
    ...
    <link href="<?php echo $themes; ?>/asserts/css/bootstrap.css" rel="stylesheet">
    <link href="<?php echo $themes; ?>/asserts/css/blog.css" rel="stylesheet">
    <title>Bootstrap 101 Template</title>
    <!--[if lt IE 9]>
    <script src="<?php echo $themes; ?>/asserts/js/html5shiv.js"></script>
    <script src="<?php echo $themes; ?>/asserts/js/respond.min.js"></script>
    <![endif]-->
</head>
<body>
